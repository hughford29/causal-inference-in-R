...
Using only observations where the needed variables are all complete is sometimes called a *complete-case analysis*, which we've been doing thus far in the book.
:::
